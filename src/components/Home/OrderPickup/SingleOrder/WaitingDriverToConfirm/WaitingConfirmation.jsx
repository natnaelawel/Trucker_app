...
import classes from "./waitingconfirmation.module.scss";
...
function WaitingConfirmation({ orderData, setOrderData, setCurrentStep }) {
    ...
    <Grid container>
      ...
      <Grid item xs={12} container className={classes.root}>
        ...
        >
          ...
          <Grid item xs={6} className={classes.map_area} container>
            <Grid item xs={12} className={classes.driver_status}>
              <DriverStatus />
            </Grid>
              ...
              <Box my={1}>
                ...
                >
                  <Typography variant="body1" color="textPrimary">
                    Waiting For Drivers To Confirm Order
                  </Typography>
                </Button>
              </Box>
            </Grid>
